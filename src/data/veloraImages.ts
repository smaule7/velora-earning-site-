...
export const VELORA_CONTENT = {
  ...
  aiPackages: {
    sectionLabel: 'AI PACKAGES & ACTIVATION',
    headline: 'AI PACKAGES',
    subtitle: 'Choose the AI package that works for you.',
    silverPlan: {
      name: 'SILVER AI PACKAGE',
      price: '₦9,500',
      numericPrice: 9500,
      tag: 'POPULAR CHOICE',
      ctaText: 'GET STARTED',
      features: [
        'Full access to Velora AI Academy & prompt generation tools',
